	...
	public void showContent() {
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (main_id != null) {
					intent = new Intent(HowtoActivity.this,HowtoActivity.class);
					...
					if (true) {
						...
						intent = new Intent(HowtoActivity.this,LoginActivity.class);
						startActivity(intent);
					}
				}
			}
	...
	public class CheckAccessTask extends AsyncTask<String, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			progressDialog.dismiss();
				...
				//		ComponentName comp = new ComponentName("com.mxtech.videoplayer.gold", "com.mxtech.videoplayer.ActivityScreen$WebDelegate");
				...
				try {
					...
					if (playerInstalledOrNot("com.mxtech.videoplayer.pro")) {
						...
						Intent intent = new Intent(HowtoActivity.this, Mxplayer.class);
						startActivity(intent);
					}
