...
public class IpTvNewActivity extends Activity {
    ...
    private ArrayList<IpTvNewData> arrDataTv = new ArrayList<IpTvNewData>();
...
//		});
    ...
    public void showContent() {
        ...
        gallery.setAdapter(new IpTvNewAdapter(getBaseContext(),
    ...
    public class DonwloadIpTvTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            IpTvNewData ipTvData = new IpTvNewData(getBaseContext());
