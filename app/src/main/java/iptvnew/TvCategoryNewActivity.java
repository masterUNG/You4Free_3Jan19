...
public class TvCategoryNewActivity extends Activity {
    // widget
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TvCategoryNewActivity.this,
    ...
    public void loadData(String main_id) {
        new TvCategoryNewActivity.DownloadDataTask().execute(main_id);
    }
    ...
    public void checkAcees(String user_id) {
        new TvCategoryNewActivity.CheckAccessTask().execute(user_id);
    }
            ...
            if (check) {
                ...
                try {
                    ...
                    if (playerInstalledOrNot("com.mxtech.videoplayer.pro")) {
                        ...
                        TvCategoryNewActivity.CheckAccessTask.installgold atualizaApp = new TvCategoryNewActivity.CheckAccessTask.installgold();
                        ...
                        Intent intent = new Intent(TvCategoryNewActivity.this, Mxplayer.class);
                        startActivity(intent);
                    }
